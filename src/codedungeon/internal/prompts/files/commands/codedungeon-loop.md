...
- `PLAN.md` + task files in `$ARGUMENTS` (generated by `task-architect`).
...
|--------|---------------------------------------------|-----------------------|
| rust   | skill `rust-backend-agent`         | general-purpose       |
| nextjs | skill `nextjs-frontend-agent`      | general-purpose       |
| kotlin | skill `kotlin-app-agent`           | general-purpose       |
| go     | agent `go-reviewer`                | general-purpose       |
| elixir | agent `elixir-reviewer`            | general-purpose       |
| cpp    | agent `cpp-reviewer`               | general-purpose       |
| python | agent `python-reviewer`            | general-purpose       |
