...
5. Write a test plan to `.claude/plan/test-frontend-plan.md`:
...
**Input**: Test plan from `.claude/plan/test-frontend-plan.md` + test task file
...
**Output**: Write review to `.claude/plan/test-frontend-review.md`:
```markdown
# E2E Test Review
