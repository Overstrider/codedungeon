...
Replaces the legacy `task-architect` splitter. Produces canonical task files (200–500 tokens each, template-conformant) + MASTER.md topo-sort per repo.
