...
- The test-api agent will execute these curl commands LITERALLY — they must be correct
...
- **If PLAYWRIGHT_SKILL_PATH is provided in the invocation prompt**, read it FIRST:
  ...
  - Include anti-patterns to avoid in the qaplan (the test-frontend agent checks these)
