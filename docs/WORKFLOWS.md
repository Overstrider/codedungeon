...
Phase 5 requires approved review evidence and a pushed PR branch. Phase 6 requires a passing verification ledger. Phase 7 requires prior phases, review evidence, verification ledger, `codedungeon git verify`, and a report generated by `codedungeon report render`.
